...
function chatController(message, senderId, payload = null) {
	if (payload != null) {
		...
		switch(message.toLowerCase()) {
			...
			case 'test':
				let testquickReply = [];
				let longpayload = "";
				for (let i = 0; i < 13; i++) {
