class EmojiChess {
	...
	static getAvailableMoves(moves) {
		...
		if (pawnMoves.length > 0) {
			...
			titleP += " (Pawn)";
			let payloadP = "Tree|" + JSON.stringify(EmojiChess.encodeMoves(pawnMoves));
		...
		if (knightMoves.length > 0) {
			...
			titleN += " (Knight)";
			let payloadN = "Tree|" + JSON.stringify(EmojiChess.encodeMoves(knightMoves));
		...
		if (bishopMoves.length > 0) {
			...
			titleB += " (Bishop)";
			let payloadB = "Tree|" + JSON.stringify(EmojiChess.encodeMoves(bishopMoves));
		...
		if (rookMoves.length > 0) {
			...
			titleR += " (Rook)";
			let payloadR = "Tree|" + JSON.stringify(EmojiChess.encodeMoves(rookMoves));
		...
		if (queenMoves.length > 0) {
			...
			titleQ += " (Queen)";
			let payloadQ = "Tree|" + JSON.stringify(EmojiChess.encodeMoves(queenMoves));
